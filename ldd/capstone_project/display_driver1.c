...
static void ili9225_fill(struct ili9225 *lcd, u16 color)
{
    ...
    ili9225_write_reg(lcd, 0x0036,219);
    ili9225_write_reg(lcd, 0x0037, 0);
    ili9225_write_reg(lcd, 0x0038, 175);
...
pr_info("write called\n");
    ...
    drawString(10,20+LINE_HEIGHT,"humidity=23%",0x0000);
    return len;
}
