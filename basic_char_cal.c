...
static int calculator(char *p)
{
    ...
    //printk(KERN_INFO "basic_char in fun:ch=%c,n1=%d,n2=%d\n",*ch,*n1,*n2);
	switch(*ch)
	{
		case('+'):res=((*n1)+(*n2));
			  break;
     ...
     printk(KERN_INFO "basic_char in fun:res=%d,ch=%c,n1=%d,n2=%d\n",res,*ch,*n1,*n2);
