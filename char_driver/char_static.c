...
#include<linux/cdev.h>       //for char device struct struct cdev,cdev_init(),cdev_add()
...
pr_info(KERN_INFO"major number:%d minor number:%d\n",MAJOR(dev),MINOR(dev));
