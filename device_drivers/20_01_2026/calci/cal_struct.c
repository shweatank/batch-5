...
//	n=rev(n);
    ...
    switch(kernel_buf.ch){
    	case '+':res=kernel_buf.a+kernel_buf.b;
		 break;
    	case '-':res=kernel_buf.a-kernel_buf.b;
		 break;
    	case '*':res=kernel_buf.a*kernel_buf.b;
    ...
    data_len=convert(kb,res);
	reverse(kernel_buf,data_len,res);
