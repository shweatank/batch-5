                          ...
                          loff_t *offset)
{
    ...
    bytes_to_copy = min(count, (size_t)(sizeof(n) - *offset));
...
static int __init led_init(void) {
    ...
    gpio_direction_input(GPIO_LED_2);  // Set as output, initial LOW
