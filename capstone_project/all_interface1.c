...
snprintf(temp_str,sizeof(temp_str),"Temperature:%d.%d%cC",buf[2],buf[3],126);
snprintf(hum_str,sizeof(hum_str),"Humidity:%d.%d%%",buf[0],buf[1]);
//drawString(0,60,temp_str,0x0000);
//drawString(0,90,hum_str,0x0000);
drawString(0,0,"temperature:"0x0000);
drawString
