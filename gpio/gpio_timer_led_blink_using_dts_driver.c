...
/*
dtc -@ -I dts -O dtb -o gpio_timer_led_blink.dtbo gpio_timer_led_blink_overlay.dts
sudo cp gpio_timer_led_blink.dtbo /boot/firmware/overlays/
sudo vim /boot/firmware/config.txt
team2@raspberrypi:~/prasanna/gpio $ sudo reboot
..insert module
then vcc to 17..output to 27
*/
