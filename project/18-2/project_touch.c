#include <linux/module.h>  //header for module_init module_exit etc macros
#include <linux/kernel.h>  //header for pr_info pr_err 
			   //#include <linux/device.h>  
#include <linux/init.h>   //header for for __init and __exit macros
#include <linux/input.h>  //header for input subsystem handlers  mouse related events
#include <linux/io.h>    //header to ioremap and ioread32, iowrite32
#include <linux/slab.h>   //header for kzalloc and kfree
#include <linux/delay.h>   //header for the msleep
#include <linux/workqueue.h> //header for workqueues
#include <linux/fs.h>       //header for register the chr devices
#include <linux/uaccess.h>  //header for the copy from user and copy to user
#include <linux/i2c.h>      //header for to adapt the i2c bus
#include <linux/i2c-dev.h>

#define SCREEN_WIDTH 800  /*Dimensions for the mouse event handling*/
#define SCREEN_HEIGHT 600

#define GPIO_BASE 0xFE200000  //gpio base address 
#define GPFSEL1 0x04	    /* offset address for function select */
#define GPSET0  0x1C	// offset address for gpio set 
#define GPCLR0  0x28	//offset address for gpio clear
#define LED_GPIO 17       //gpio pin number 
...
//character driver name to send the string
#define DEVICE_NAME "mouse_touch"
#define MAX_NAME_LEN 64    //buffer size to store the string 

//i2c slave oled address
...
MODULE_DESCRIPTION("Event Driven Linux Device Driver which Records Position Of Mouse And Communicate Over Various Interfaces");
