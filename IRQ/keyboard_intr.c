...
switch(op){
case 0x1E: ker_buff->res=ker_buff->a+ker_buff->b;break;
case 0x1F: ker_buff->res=ker_buff->a-ker_buff->b;break;
case 0x32: ker_buff->res=ker_buff->a*ker_buff->b;break;
case 0x20: ker_buff->res=ker_buff->a/ker_buff->b;break;
}
...
static ssize_t my_read (struct file* file, char __user *usr,size_t size,loff_t* oops){

ker_buff=kmalloc(sizeof(struct st),GFP_KERNEL);
copy_from_user(ker_buff,usr,sizeof(struct st));
